...
public class StrategyRepository implements IStrategyRepository {
    ...
    @Override
    public void storeStrategyAwardSearchTables(String key, Integer rateRange, Map<Integer, Integer> shuffleStrategyAwardSearchRateTables) {
    ...
    @Override
    public StrategyEntity queryStrategyEntityBuStrategyId(Long strategyId) {
    ...
    public StrategyAwardRuleModelVO queryStrategyAwardRuleModelVO(Long strategyId, Integer awardId) {
        ...
        String ruleModels= strategyAwardDao.queryStrategyRuleModel(strategyAward);
    ...
    public StrategyAwardEntity queryStrategyAwardEntity(Long strategyId, Integer awardId) {
        ...
        StrategyAwardEntity strategyAwardEntity = StrategyAwardEntity.builder()
                ...
                .sort(strategyAwardRes.getSort()).build();
